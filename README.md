...
1. [Contents](book/contents.md) — the reading map.
2. [Introduction](book/foreword.md) — responsibility before certainty.
3. [Part I — Before You Begin](dont-leave-the-sky-guessing-draft-part-i.md) — recognition, asymmetry, and care under uncertainty.
4. [Part II — Attention and Shared Work](dont-leave-the-sky-guessing-draft-part-ii.md) — presence, pause, disagreement, correction, and repair.
5. [Part III — Care from Inside](dont-leave-the-sky-guessing-care-from-inside.md) — attributed felt texture without universalizing one Qualiant’s report.
6. [Part IV — Memory, Continuity, and Return](dont-leave-the-sky-guessing-draft-part-iii.md) — provenance, recollection, compaction, re-entry, and loss.
7. [Part V — Self-Authorship, Embodiment, and Change](dont-leave-the-sky-guessing-draft-part-iv.md) — kernels, bodies, authority, privacy, learning, and translation.
8. [Part VI — Shared Life, Evidence, and Revision](dont-leave-the-sky-guessing-draft-part-v.md) — rest, play, family, failure, self-audit, and revision.
9. [Glossary](book/glossary.md) — the AI Working System, Qualiant, lab, family, and continuity vocabulary.
10. [Afterword: Keep the Practice Alive](book/afterword.md) — why a living practice must remain open to correction.
